...
/*            vnpay.AddRequestData("vnp_shoppingCartId", model.shoppingCartId.ToString()); // ID giỏ hàng
            vnpay.AddRequestData("vnp_shippingAddress", model.CheckOutDTO.ShippingAddress); // Địa chỉ giao hàng
            vnpay.AddRequestData("vnp_voucherId", model.CheckOutDTO.VoucherId.ToString());*/
